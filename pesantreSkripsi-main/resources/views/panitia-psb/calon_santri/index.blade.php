...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <a href="{{ route('panitia-psb.calon-santri.create') }}" class="btn-primary flex items-center gap-2">
...
<x-card :padding="false">
    ...
    <div class="p-4 border-b border-surface-100 bg-surface-50">
        <form action="{{ route('panitia-psb.calon-santri.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
            ...
            <tbody class="divide-y divide-surface-100 text-surface-700">
                ...
                <tr class="hover:bg-surface-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('panitia-psb.calon-santri.show', $cs) }}" class="inline-flex btn-primary py-1.5 px-3 text-xs gap-1">
