...
class JadwalNgajiKitabSeeder extends Seeder
{
    public function run()
    {
        ...
        // 3. Pastikan Mata Pelajaran 'Ta'limul Muta'allim' Ada untuk Setiap Lembaga
        $mapelKitabMap = [];
        foreach ($lembagas as $l) {
            $mapel = MataPelajaran::firstOrCreate(
                ['nama' => 'Ta\'limul Muta\'allim (Ngaji Kitab)', 'lembaga_id' => $l->id],
                ['is_active' => true]
            );
