            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <select name="gender_target" required class="w-full rounded-lg border border-surface-300 bg-white px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500">
                        <option value="CAMPUR" {{ old('gender_target') == 'CAMPUR' ? 'selected' : '' }}>Campur (Putra & Putri)</option>
                        <option value="PUTRA" {{ old('gender_target') == 'PUTRA' ? 'selected' : '' }}>Khusus Putra (Santri Laki-laki)</option>
                        <option value="PUTRI" {{ old('gender_target') == 'PUTRI' ? 'selected' : '' }}>Khusus Putri (Santri Perempuan)</option>
                    </select>
                </div>
                <div>
