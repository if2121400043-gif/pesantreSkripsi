...
<head>
    ...
    <title>@yield('title', 'Portal Guru') — PP Nurul Furqon</title>
...
<body class="min-h-screen bg-surface-50 overflow-x-hidden text-surface-900 font-sans">
    ...
    <div class="min-h-screen flex flex-col" id="app-guru-layout">
        ...
        {{-- Flash Messages --}}
        <div class="max-w-screen-xl mx-auto w-full px-4 sm:px-6 lg:px-8 mt-4">
            @if(session('success'))
        ...
        <main class="flex-1 max-w-screen-xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6" id="main-content">
            @yield('content')
        </main>

        {{-- Footer --}}
        <footer class="bg-white border-t border-surface-200 py-6 mt-auto">
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-xs text-surface-500">
