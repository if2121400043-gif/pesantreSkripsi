            ...
            <tbody class="divide-y divide-surface-100 text-surface-700">
                ...
                <tr class="hover:bg-surface-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right">
                        ...
                        <form action="{{ route('admin.komponen-biaya.destroy', $biaya) }}" method="POST" class="inline-block" onsubmit="return confirm('Hapus komponen biaya ini?');">
                            @csrf
                            @method('DELETE')
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class="relative transform overflow-visible rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md">
                ...
                <form id="form-biaya" action="{{ route('admin.komponen-biaya.store') }}" method="POST">
                    @csrf
...
<script>
    ...
    function openModal() {
        form.reset();
        form.action = "{{ route('admin.komponen-biaya.store') }}";
    ...
    function editBiaya(data) {
        form.action = `/admin/komponen-biaya/${data.id}`;
