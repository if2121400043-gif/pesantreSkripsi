...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('panitia-psb.calon-santri.store') }}" method="POST">
        @csrf
        <div class="space-y-6">
            ...
            <x-card title="Kontak & Wali">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="tinggal_bersama" id="panitia_tinggal_bersama" class="{{ $inputCls }}" onchange="togglePanitiaWali()">
            ...
            <div id="panitia-wali-section" style="display: none;">
                <x-card title="Data Wali">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div><label class="block text-sm font-medium text-surface-700 mb-1">Nama Wali</label><input type="text" name="nama_wali" class="{{ $inputCls }}"></div>
                        <div>
            ...
            <script>
            function togglePanitiaWali() {
                var el = document.getElementById('panitia_tinggal_bersama');
                var section = document.getElementById('panitia-wali-section');
