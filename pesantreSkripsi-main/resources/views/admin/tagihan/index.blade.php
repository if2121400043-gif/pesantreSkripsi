...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="flex flex-wrap gap-3">
        ...
        <form action="{{ route('admin.tagihan.blast-reminder') }}" method="POST"
        ...
        @endif
        <a href="{{ route('admin.tagihan.create') }}" class="btn-primary flex items-center gap-2">
...
<x-card :padding="false">
    ...
    <div class="p-4 border-b border-surface-100 bg-surface-50">
        <form action="{{ route('admin.tagihan.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
            ...
            @if(request()->anyFilled(['search', 'status', 'tahun_pelajaran_id']))
                <a href="{{ route('admin.tagihan.index') }}" class="btn-secondary px-4 py-2 text-danger-600 border-danger-200 hover:bg-danger-50 flex items-center justify-center">
            ...
            <tbody class="divide-y divide-surface-100 text-surface-700">
                ...
                <tr class="hover:bg-surface-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('admin.tagihan.show', $tagihan) }}" class="inline-flex btn-primary py-1 px-3 text-xs gap-1">
