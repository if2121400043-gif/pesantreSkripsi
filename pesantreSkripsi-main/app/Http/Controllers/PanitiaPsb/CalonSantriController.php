...
class CalonSantriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('panitia-psb.calon-santri.index')->with('success', 'Pendaftaran Calon Santri berhasil disimpan.');
    }

    public function show(CalonSantri $calonSantri)
    {
        $calonSantri->load(['gelombang', 'lembagaTujuan', 'verifikator', 'dokumen']);
        return view('panitia-psb.calon_santri.show', compact('calonSantri'));
    }
    ...
    {
        $calonSantri->delete();
        return redirect()->route('panitia-psb.calon-santri.index')->with('success', 'Data calon santri berhasil dihapus.');
    }
