...
@section('title', '403 — Akses Dibatasi | PP Nurul Furqon')
...
<div class="min-h-screen flex items-center justify-center bg-surface-50 px-4 py-12">
    <div class="max-w-md w-full text-center space-y-6 bg-white p-8 md:p-10 rounded-3xl border border-surface-200 shadow-xl relative overflow-hidden">
        <div class="w-20 h-20 bg-rose-50 text-rose-600 rounded-3xl flex items-center justify-center mx-auto border border-rose-100 shadow-sm">
            <i data-lucide="shield-alert" class="w-10 h-10"></i>
        </div>
        <div>
            <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-100 text-rose-800 text-xs font-black uppercase tracking-wider mb-2">
                Error 403
            </div>
            <h1 class="text-2xl md:text-3xl font-extrabold text-surface-900 font-heading">Akses Dibatasi</h1>
            <p class="text-xs md:text-sm text-surface-500 mt-2 leading-relaxed">
                Maaf, Anda tidak memiliki hak akses untuk membuka fitur atau halaman ini.
            </p>
        </div>
